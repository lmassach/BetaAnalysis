...
def main():
    ...
    bins = 200
    axes[0].hist(
        a_max_fam1, bins=bins, range=(80, 280), color="skyblue", edgecolor="black"
    )
    axes[1].hist(
        a_max_fam2, bins=bins, range=(80, 280), color="skyblue", edgecolor="black"
    )
    axes[2].hist(
        a_max_fam3, bins=bins, range=(80, 280), color="skyblue", edgecolor="black"
    )
