...
def main():
    ...
    for i in range(1):
        ...
        ax.scatter(
            reshaped_time_data[500], original, color="blue", label="Before noise"
        )
        ax.scatter(
            reshaped_time_data[500],
            reshaped_ampl_data[500],
            color="red",
            label="After noise",
            marker="x",
        )
    ...
    if make_populated_plots:
        ...
        fig.suptitle(
            f"UFSD 3.2 W7 300V : Total {len(a_max)} signal events",
            fontsize=25,
            fontweight="bold",
        )
    ...
    if time_res_calc:
        ...
        for fam_ind, fam_proper in enumerate([amp_fam_1_ind]):
            ...
            fig.suptitle(
                f"UFSD 3.2 W7 300V : Total {len(fam_proper)} signal events",
                fontsize=25,
                fontweight="bold",
            )
            plt.tight_layout(rect=[0, 0, 1, 0.96])
