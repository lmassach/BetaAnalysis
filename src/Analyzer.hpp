...
public:
  ...
  // void Correct_Baseline2( std::vector<double> &voltageVec, double
  // fractional_pts ); void Correct_Baseline3( std::vector<double> &voltageVec,
  // std::vector<double> timeVec, double tRange[2] ); //special treatment of
  // ill-signal baseline.

  //==========================================================================
  // Pulse Maximum (Pmax)
  std::pair<double, unsigned int> Find_Signal_Maximum(bool confineSearchRegion,
                                                      double searchRange[2]);
  std::pair<double, double>
  Pmax_with_GausFit(const std::pair<double, unsigned int> Pmax,
                    unsigned int maxIndex);
  std::pair<double, unsigned int>
  Find_Negative_Signal_Maximum(bool confineSearchRegion, double searchRange[2]);
  std::pair<double, double>
  Negative_Pmax_with_GausFit(const std::pair<double, unsigned int> NegPmax,
                             unsigned int maxIndex);
  ...
  double Pulse_Integration_with_Fixed_Window_Size_with_GausFit(
      const std::pair<double, double> pmax_holder, unsigned int imax,
      std::string integration_option, double t_beforeSignal,
      double t_afterSignal);
  ...
  double Pulse_Area_With_Linear_Interpolate_Edge_with_GausFit(
      const std::pair<double, double> Pmax, unsigned int imax,
      std::string integration_option, bool relativeTimeWindow, double stopTime);

  double New_Pulse_Area(const std::pair<double, double> Pmax, unsigned int imax,
                        std::string integration_option, double range[2]);

  double New_Undershoot_Area(const std::pair<double, double> Pmax,
                             const std::pair<double, double> Pmin,
                             unsigned int imin, std::string integration_option,
                             double range[2]);
  ...
  double Rising_Edge_CFD_Time(const double fraction,
                              const std::pair<double, unsigned int> Pmax);
  double Rising_Edge_CFD_Time_with_GausFit(const double fraction,
                                           const std::pair<double, double> Pmax,
                                           unsigned int imax);
  double
  Falling_Edge_CFD_Time_with_GausFit(const double fraction,
                                     const std::pair<double, double> Pmax,
                                     unsigned int imax);

  //==========================================================================
  // Rise Time
  double Find_Rise_Time(const std::pair<double, unsigned int> Pmax,
  ...
  double Find_Dvdt(const int fraction, const int ndif,
                   const std::pair<double, unsigned int> Pmax);
  double Find_Dvdt_with_GausFit(const int fraction, const int ndif,
                                const std::pair<double, double> Pmax,
                                unsigned int imax);
  double Find_Dvdt2080_with_GausFit(const int ndif,
                                    const std::pair<double, double> Pmax,
                                    unsigned int imax);
  ...
  // time at threshold
  double
  Find_Time_At_Threshold_with_GausFit(const double thresholdLevel,
                                      const std::pair<double, double> Pmax,
                                      unsigned int imax);
  double Find_Time_At_Threshold_Falling_Edge_with_GausFit(
      const double thresholdLevel, const std::pair<double, double> Pmax,
      unsigned int imax);
  double Find_Time_Over_Threshold(const double thresholdLevel,
                                  const std::pair<double, unsigned int> Pmax,
