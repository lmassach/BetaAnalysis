...
def main():
    ...
    for i in range(1):
        ...
        for j in range(num_curves):
            ...
            if make_plots:
                ...
                plt.scatter(
                    reshaped_time_data[j],
                    reshaped_ampl_data[j],
                    s=20,
                    c=colours[i],
                    marker="o",
                    edgecolor=edges[i],
                    linewidth=0.5,
                    alpha=alphas[i],
                    label=labels[i] + " " + str(round(1000 * pmax, 2)) + " mV",
                    zorder=1,
                )
                plt.plot(
                    x_linspace,
                    np.polyval(parabola_coeffs, x_linspace),
                    "r",
                    label="Parabolic Fit",
                    linewidth=2,
                    zorder=2,
                ...
                plt.axhline(
                    ...
                    linestyle=":",
                    label=r"A$_{para}$: "
                    + str(round(1000 * y_parabola_max, 2))
                    + " mV",
                    linewidth=2,
                    zorder=3,
                )
                plt.axhline(
                    ...
                    linestyle=":",
                    label=r"A$_{Gaus}$: "
                    + str(round(1000 * gaussian(mu, *params), 2))
                    + " mV",
                    linewidth=2,
                    zorder=3,
                )
                ...
                plt.axhline(
                    ...
                    color="purple",
                    linestyle=":",
                    label=r"A$_{Voigt}$: " + str(round(1000 * voigt_peak, 2)) + " mV",
                    linewidth=2,
                    zorder=3,
                )
                plt.axhline(
                    ...
                    color="orange",
                    linestyle=":",
                    label=r"A$_{spline}$: " + str(round(1000 * spline_peak, 2)) + " mV",
                    linewidth=2,
                    zorder=3,
                )
                plt.axhline(
                    ...
                    color="cyan",
                    linestyle=":",
                    label=r"A$_{Landau}$: " + str(round(1000 * landau_peak, 2)) + " mV",
                    linewidth=2,
                    zorder=3,
                )
                plt.scatter(
    ...
    if make_populated_plots:
        ...
        gs = gridspec.GridSpec(
            6, 3, height_ratios=[1, 1, 1, 1, 1, 1], width_ratios=[1, 1, 1]
        )
        ...
        ax1.scatter(
            ...
            + "\nMAE = "
            + str(round(mae_tot_para, 4))
            + " RMSE = "
            + str(round(rmse_tot_para, 4)),
        )
        ...
        ax3.scatter(
            ...
            + "\nMAE = "
            + str(round(mae_tot_lorentz, 4))
            + " RMSE = "
            + str(round(rmse_tot_lorentz, 4)),
        )
        ...
        ax4.scatter(
            ...
            + "\nMAE = "
            + str(round(mae_tot_voigt, 4))
            + " RMSE = "
            + str(round(rmse_tot_voigt, 4)),
        )
        ...
        ax5.scatter(
            ...
            + "\nMAE = "
            + str(round(mae_tot_spline, 4))
            + " RMSE = "
            + str(round(rmse_tot_spline, 4)),
        )
        ...
        ax6.scatter(
            ...
            + "\nMAE = "
            + str(round(mae_tot_landau, 4))
            + " RMSE = "
            + str(round(rmse_tot_landau, 4)),
        )
    ...
    if cfd_studies:
        ...
        rms_diff_gaus = np.sqrt(
            np.mean((np.array(cfd20_data) - np.array(cfd20_gaus)) ** 2)
        ).round(3)
        axes[0, 1].hist(
            cfd20_data,
            bins=100,
        ...
        rms_diff_lorentz = np.sqrt(
            np.mean((np.array(cfd20_data) - np.array(cfd20_lorentz)) ** 2)
        ).round(3)
        axes[1, 0].hist(
            cfd20_data,
            bins=100,
        ...
        rms_diff_voigt = np.sqrt(
            np.mean((np.array(cfd20_data) - np.array(cfd20_voigt)) ** 2)
        ).round(3)
        axes[1, 1].hist(
            cfd20_data,
            bins=100,
        ...
        rms_diff_spline = np.sqrt(
            np.mean((np.array(cfd20_data) - np.array(cfd20_spline)) ** 2)
        ).round(3)
        axes[0, 2].hist(
            cfd20_data,
            bins=100,
        ...
        rms_diff_landau = np.sqrt(
            np.mean((np.array(cfd20_data) - np.array(cfd20_landau)) ** 2)
        ).round(3)
        axes[1, 2].hist(
            cfd20_data,
            bins=100,
